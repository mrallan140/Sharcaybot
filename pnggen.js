...
module.exports = async (title, subtitle, content) => {
  ...
  background-blend-mode: multiply;
    ...
    <body>
      <div class="title"> 
        <h2 id="Title" contenteditable="true">${title}</h2>
        <h3 id="Subtitle" contenteditable="true">${subtitle}</h3>
      </div>
      <div class="line"></div>
      <div class="app">
        
        <h4 id="Content" contenteditable="true">${content}</h4>
      </div>
    </body>
  </html>
`
